...
public class OpenCategoryCreator {
	public static void main(String[] args) {
		try{
			//Per leggere da csv
			CSVReader reader = new CSVReader(new FileReader("FinalOpen.csv") , '\t');
			//Per scrivere un nuovo file csv
			System.out.println("Letto" );
			FileWriter writer = new FileWriter("OpenWithCategory.csv");
			...
			writer.append(h[0].substring(3)+ "\t" + h[1]+ "\t" + "Category\t"+ h[2] + "\t" + h[3]+ "\t" + h[4]+ "\t" + h[5]+ "\t" + h[6]+ "\t" + h[7]+ "\t" + h[8]+ "\t" + h[9]+ "\t" + h[10]+ "\t" + h[11]+ "\t" + h[12]+ "\t" + "Body Without URL\t Itemization\t Screenshots\t Fog Index\t Flesch Score\t Kincaid Score" );
			writer.append("\n");
